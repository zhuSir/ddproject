...
<body>
	...
	<input id="userPhone" type="hidden" value="${userInfo.phone}" />
		<div class="sh">
			<ul>
				<li><span>名称：</span> <input type="text" placeholder="填写项目名称"
					name="name" id="name" data-info="请填写项目名称" /></li>
				<li><span>团队：</span> <input type="text" class="black"
					id="companyName" name="companyName" data-info="请填写团队名称" value="${userInfo.companyName}"/></li>
			</ul>
		</div>
		<div class="zh">
			<ul>
		...
		<div class="xia">
			<ul>
				<li class="lis">
					...
					<p class="p2">
						姓名： <input type="text" placeholder="维保负责人姓名" id="ownerName"
							name="ownerName" data-info="请填写姓名" />
					</p>
				</li>
				<li class="lst"><span>电话：</span> <input type="text" placeholder="维保负责人电话"
					class="black" id="ownerPhone" name="ownerPhone" data-info="请填写联系电话" />
				</li>
			</ul>
		</div>
		<button type="submit" id="submit" data-type="0">提交</button>
	</div>
	<div class="wrap"></div>
	<div class="share">
		<div class="sh">
